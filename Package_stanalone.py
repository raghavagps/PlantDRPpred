...
def run_option_2(input_file, output_file="output_results.csv"):
    ...
    subprocess.run(["python3", "PSSM/POSSUM_Standalone_Toolkit/src/possum.py", "-i", "Fea_Seq/pssm_sequences.fasta", "-o", "Fea_Seq/PSSM_feature.csv", "-t", "pssm_composition", "-p", "Fea_Seq/file_split/pssm_raw"])
    subprocess.run(["python3", "PSSM/POSSUM_Standalone_Toolkit/src/headerHandler.py", "-i", "Fea_Seq/PSSM_feature.csv", "-o", "Fea_Seq/Pssm_w_Header.csv", "-p", "PRR"])
